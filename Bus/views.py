...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            return render(request, 'Bus/list.html', locals())
        else:
            context["error"] = "Sorry no buses availiable"
            return render(request, 'Bus/findbus.html', context)
    else:
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.rem > int(seats_r):
                ...
                # book.save()
                return render(request, 'Bus/bookings.html', locals())
            else:
...
def cancellings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'Bus/error.html', context)
    else:
        return render(request, 'Bus/findbus.html')
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'Bus/booklist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'Bus/thank.html')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'Bus/signup.html', context)
    else:
        return render(request, 'Bus/signup.html', context)
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            return render(request, 'Bus/success.html', context)
            # return HttpResponseRedirect('success')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'Bus/signin.html', context)
    else:
